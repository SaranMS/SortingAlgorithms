public class MergeSort {
	...
	public static void mergeSort(int[] Array, int left, int right) {	//(array, 0, array.length-1)
		if (right > left) {
			int m = (left + right) / 2;
			mergeSort(Array, left, m);								//Calls recursively on 1st half
			mergeSort(Array, m + 1, right);							//Calls recursively on 2nd half
			merge(Array, left, m, right);							//Calls merge function on divided array
		}
	}//end of method
